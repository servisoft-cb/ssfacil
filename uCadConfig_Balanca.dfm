object frmConfigBalanca: TfrmConfigBalanca
  ...
  Width = 1004
  Height = 590
  Caption = 'Configura'#231#227'o Balan'#231'a - frmConfigBalanca'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Height = 444
        Align = alClient
        DataSource = DMConfig_Balanca.dsConfigBalanca
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object Panel1: TPanel
        ...
        object btnGerarArquivo: TNxButton
          Left = 468
          Top = 1
          Width = 153
          Height = 30
      ...
      object pnlCadastro: TPanel
        ...
        object grp1: TGroupBox
          ...
          object dbedtID_POSICAO: TDBEdit
            Left = 74
            Top = 34
            Width = 65
            Height = 21
          ...
          object dbedtID_TAMANHO: TDBEdit
            Left = 142
            Top = 34
            Width = 60
            Height = 21
        ...
        object grp2: TGroupBox
          ...
          object dbedtID_POSICAO1: TDBEdit
            Left = 5
            Top = 34
            Width = 65
            Height = 21
          ...
          object dbedtID_TAMANHO1: TDBEdit
            Left = 74
            Top = 34
            Width = 60
            Height = 21
            DataField = 'COD_TAMANHO'
            DataSource = DMConfig_Balanca.dsConfigBalanca
            TabOrder = 1
          end
        end
        object grp3: TGroupBox
          ...
          object dbedtID_POSICAO2: TDBEdit
            Left = 4
            Top = 34
            Width = 65
            Height = 21
            DataField = 'VLR_POSICAO'
            DataSource = DMConfig_Balanca.dsConfigBalanca
            TabOrder = 0
          end
          object dbedtID_TAMANHO2: TDBEdit
            Left = 72
            Top = 34
            Width = 60
            Height = 21
            DataField = 'VLR_TAMANHO'
            DataSource = DMConfig_Balanca.dsConfigBalanca
            TabOrder = 1
          end
        ...
        object grp4: TGroupBox
          ...
          object dbedtVLR_POSICAO: TDBEdit
            Left = 4
            Top = 34
            Width = 79
            Height = 21
          ...
          object comboUsaSeparador: TRxDBComboBox
            Left = 87
            Top = 34
            Width = 86
            Height = 21
            Style = csDropDownList
            DataField = 'USA_SEPARADOR'
            DataSource = DMConfig_Balanca.dsConfigBalanca
            EnableValues = True
            ItemHeight = 13
            Items.Strings = (
          ...
          object dbedtVLR_TAMANHO: TDBEdit
            Left = 176
            Top = 34
            Width = 74
            Height = 21
            DataField = 'TIPO_SEPARADOR'
            DataSource = DMConfig_Balanca.dsConfigBalanca
            TabOrder = 2
          end
        end
        object grp5: TGroupBox
          ...
          TabOrder = 4
          object dbedtNOMEARQ_TXT: TDBEdit
            Left = 8
            Top = 32
            Width = 329
            Height = 21
            DataField = 'NOMEARQ_TXT'
            DataSource = DMConfig_Balanca.dsConfigBalanca
            TabOrder = 0
          end
          ...
          object RzPageControl2: TRzPageControl
            ...
            object TabSheet1: TRzTabSheet
              ...
              object Panel6: TPanel
                ...
                Color = clSilver
                TabOrder = 0
                object btnInserir_Lay: TNxButton
                  Left = 1
                  Top = 1
                  Width = 142
                  Height = 29
                  ...
                  TabOrder = 0
                  Transparent = True
                  OnClick = btnInserir_LayClick
                end
                object btnAlterar_Lay: TNxButton
                  Left = 143
                  Top = 1
                  Width = 147
                  Height = 29
                  ...
                  TabOrder = 1
                  Transparent = True
                  OnClick = btnAlterar_LayClick
                end
                object btnExcluir_Lay: TNxButton
                  Left = 290
                  Top = 1
                  Width = 147
                  Height = 29
