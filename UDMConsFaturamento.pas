...
type
  TDMConsFaturamento = class(TDataModule)
    ...
    sdsProduto_Det_Geral: TSQLDataSet;
    dspProduto_Det_Geral: TDataSetProvider;
    cdsProduto_Det_Geral: TClientDataSet;
    dsProduto_Det_Geral: TDataSource;
    frxProduto_Det_Geral: TfrxDBDataset;
    cdsProduto_Det_GeralVLR_TOTAL: TFloatField;
    cdsProduto_Det_GeralID_PRODUTO: TIntegerField;
    cdsProduto_Det_GeralREFERENCIA: TStringField;
    cdsProduto_Det_GeralNOME_PRODUTO_SERV: TStringField;
    cdsProduto_Det_GeralQTD: TFloatField;
    cdsProduto_Det_GeralUNIDADE: TStringField;
    cdsProduto_Det_GeralVLR_UNITARIO: TFloatField;
    cdsProduto_Det_GeralVLR_TOTAL_GERAL: TFloatField;
    cdsProduto_Det_GeralNUM_NOTA: TIntegerField;
    cdsProduto_Det_GeralNUM_RPS: TIntegerField;
    cdsProduto_Det_GeralFILIAL: TIntegerField;
    cdsProduto_Det_GeralNOME_CLIENTE: TStringField;
    cdsProduto_Det_GeralDTEMISSAO: TDateField;
    cdsProduto_Det_GeralDTENTRADASAIDA: TDateField;
    cdsProduto_Det_GeralVLR_DESCONTO: TFloatField;
    cdsProduto_Det_GeralSERIE: TStringField;
    cdsProduto_Det_GeralTIPO_MOV: TStringField;
    cdsProduto_Det_GeralTIPO_ES: TStringField;
    cdsProduto_Det_GeralTIPO_REG: TStringField;
    cdsProduto_Det_GeralVLR_ICMSSUBST: TFloatField;
    cdsProduto_Det_GeralID_COR: TIntegerField;
    cdsProduto_Det_GeralNOME_COR: TStringField;
    cdsProduto_Det_GeralBENEFICIAMENTO: TStringField;
    cdsProduto_Det_GeralFATURAMENTO: TStringField;
    ...
    sdsCupomFiscalAnalitico: TSQLDataSet;
    dspCupomFiscalAnalitico: TDataSetProvider;
    cdsCupomFiscalAnalitico: TClientDataSet;
    dsCupomFiscalAnalitico: TDataSource;
    cdsCupomFiscalAnaliticoQTD: TFloatField;
    cdsCupomFiscalAnaliticoVLR_TOTAL: TFloatField;
    cdsCupomFiscalAnaliticoREFERENCIA: TStringField;
    cdsCupomFiscalAnaliticoNOME: TStringField;
    cdsCupomFiscalAnaliticoFILIAL: TIntegerField;
    sdsCupomFiscalAnaliticoDia: TSQLDataSet;
    dspCupomFiscalAnaliticoDia: TDataSetProvider;
    cdsCupomFiscalAnaliticoDia: TClientDataSet;
    dsCupomFiscalAnaliticoDia: TDataSource;
    ...
    cdsCupomFiscalvlrConsulta: TAggregateField;
    cdsCupomFiscalAnaliticoVlrConsulta: TAggregateField;
    cdsCupomFiscalAnaliticoDiaVlrConsulta: TAggregateField;
