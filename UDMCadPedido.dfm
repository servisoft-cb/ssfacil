object DMCadPedido: TDMCadPedido
  ...
  object sdsPedido_Itens: TSQLDataSet
    ...
    object sdsPedido_ItensENCOMENDA: TStringField
      FieldName = 'ENCOMENDA'
      FixedChar = True
      Size = 1
    end
  ...
  object cdsPedidoImp: TClientDataSet
    ...
    object cdsPedidoImpAMOSTRA: TStringField
      FieldName = 'AMOSTRA'
      Size = 1
    end
    object cdsPedidoImpID_TIPO_COBRANCA: TIntegerField
      FieldName = 'ID_TIPO_COBRANCA'
    end
    object cdsPedidoImpNOME_TIPO_COBRANCA: TStringField
  ...
  object cdsPedidoImp_Itens: TClientDataSet
    ...
    object cdsPedidoImp_ItensMOSTRAR_GROSA: TStringField
  ...
  object qParametros_Ped: TSQLQuery
    ...
    object qParametros_PedMOSTRAR_TIPO_COBR: TStringField
  ...
  object sdsPedido_Consulta2: TSQLDataSet
    CommandText = 
      ...
      'NPJ_CPF, PED.ID_VENDEDOR_INT,'#13#10'       ped.reordem,'#13#10'cast(0 AS Fl' +
      'oat) VALOR_CUSTO , cast(0 AS INTEGER) cont_talao, cast(0 AS INTE' +
      'GER) cont_talao2,'#13#10'cast(0 AS INTEGER) CONTADOR_PROCESSO, cast('#39#39 +
      ' AS varchar(30)) DESCRICAO_STATUS,'#13#10'cast('#39#39' AS varchar(1)) GEROU' +
      '_PRODUCAO,'#13#10'cast('#39#39' AS varchar(60)) nome_vendedor_int,'#13#10'cast(NUL' +
      'L AS Date) DTAPROVADO,'#13#10'cast('#39#39' AS varchar(60)) nome_transportad' +
      'ora,'#13#10'cast('#39#39' AS varchar(6)) DESC_ARQ_ANEXO'#13#10#13#10'from PEDIDO PED'#13#10 +
      'inner join PESSOA CLI on CLI.CODIGO = PED.ID_CLIENTE'#13#10'left join ' +
      'PESSOA VEND on VEND.CODIGO = PED.ID_VENDEDOR'#13#10'left join OPERACAO' +
      '_NOTA OPN on PED.ID_OPERACAO_NOTA = OPN.ID'#13#10#13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = dmDatabase.scoDados
    Left = 248
  ...
  object dspPedidoItemTipoFoto: TDataSetProvider
    DataSet = sdsPedidoItemTipoFoto
    Left = 328
    Top = 592
  end
  object cdsPedidoItemTipo_Foto: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspPedidoItemTipoFoto'
    Left = 344
    Top = 592
    object cdsPedidoItemTipo_FotoID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object cdsPedidoItemTipo_FotoITEM: TIntegerField
      FieldName = 'ITEM'
      Required = True
    end
    object cdsPedidoItemTipo_FotoFOTO: TStringField
      FieldName = 'FOTO'
      Size = 200
    end
  end
  object dsPedidoItemTipoFoto: TDataSource
    DataSet = cdsPedidoItemTipo_Foto
    Left = 360
    Top = 592
  end
  ...
  object mProcesso_Sel: TClientDataSet
    ...
    Params = <>
    StoreDefs = True
    OnNewRecord = mProcesso_SelNewRecord
    Left = 1038
    Top = 610
    Data = {
      ...
      0D5573615F5174645F446F627261010049000000010005574944544802000200
      01000000}
    ...
    object mProcesso_SelUsa_Qtd_Dobra: TStringField
      FieldName = 'Usa_Qtd_Dobra'
      Size = 1
    end
  end
  ...
  object sdsOrcamento_Item_Processo: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 
      'select P.*'#13#10'from PEDIDO_ITEM_PROCESSO P'#13#10'where P.ID = :ID and'#13#10' ' +
  ...
  object dspOrcamento_Item_Processo: TDataSetProvider
    DataSet = sdsOrcamento_Item_Processo
    Left = 1204
    Top = 606
  end
  object cdsOrcamento_Item_Processo: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspOrcamento_Item_Processo'
    Left = 1231
    Top = 604
    object cdsOrcamento_Item_ProcessoID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object cdsOrcamento_Item_ProcessoITEM: TIntegerField
      FieldName = 'ITEM'
      Required = True
    end
    object cdsOrcamento_Item_ProcessoITEM_PROCESSO: TIntegerField
      FieldName = 'ITEM_PROCESSO'
      Required = True
    end
    object cdsOrcamento_Item_ProcessoID_PROCESSO: TIntegerField
      FieldName = 'ID_PROCESSO'
    end
    object cdsOrcamento_Item_ProcessoQTD: TFloatField
      FieldName = 'QTD'
    end
    object cdsOrcamento_Item_ProcessoDTENTRADA: TDateField
      FieldName = 'DTENTRADA'
    end
    object cdsOrcamento_Item_ProcessoHRENTRADA: TTimeField
      FieldName = 'HRENTRADA'
    end
    object cdsOrcamento_Item_ProcessoDTBAIXA: TDateField
      FieldName = 'DTBAIXA'
    end
    object cdsOrcamento_Item_ProcessoHRSAIDA: TTimeField
      FieldName = 'HRSAIDA'
    end
    object cdsOrcamento_Item_ProcessoQTD_DOBRA: TIntegerField
      FieldName = 'QTD_DOBRA'
    end
  end
  object sdsPedidoImp_Item_Proc: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 
      'SELECT PC.*,'#13#10'CASE'#13#10' WHEN P.usar_qtd_dobra = '#39'S'#39' THEN p.nome || ' +
      #39' Qtd.: '#39' || round(coalesce(pc.qtd_dobra,1))'#13#10' else P.NOME'#13#10' end' +
      ' NOME_PROCESSO'#13#10'FROM PEDIDO_ITEM_PROCESSO PC'#13#10'INNER JOIN PROCESS' +
      'O P ON PC.id_processo = P.ID'#13#10'WHERE PC.ID = :ID'#13#10'  AND PC.ITEM =' +
      ' :ITEM'#13#10
    MaxBlobSize = -1
    Params = <
      item
  ...
  object cdsPedidoImp_Item_Proc: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'ID;ITEM;ITEM_PROCESSO'
    Params = <>
    ProviderName = 'dspPedidoImp_Item_Proc'
    OnNewRecord = cdsPedido_ItensNewRecord
    Left = 209
    Top = 613
    object cdsPedidoImp_Item_ProcID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object cdsPedidoImp_Item_ProcITEM: TIntegerField
      FieldName = 'ITEM'
      Required = True
    end
    object cdsPedidoImp_Item_ProcITEM_PROCESSO: TIntegerField
      FieldName = 'ITEM_PROCESSO'
      Required = True
    end
    object cdsPedidoImp_Item_ProcID_PROCESSO: TIntegerField
      FieldName = 'ID_PROCESSO'
    end
    object cdsPedidoImp_Item_ProcQTD: TFloatField
      FieldName = 'QTD'
    end
    object cdsPedidoImp_Item_ProcDTENTRADA: TDateField
      FieldName = 'DTENTRADA'
    end
    object cdsPedidoImp_Item_ProcHRENTRADA: TTimeField
      FieldName = 'HRENTRADA'
    end
    object cdsPedidoImp_Item_ProcDTBAIXA: TDateField
      FieldName = 'DTBAIXA'
    end
    object cdsPedidoImp_Item_ProcHRSAIDA: TTimeField
      FieldName = 'HRSAIDA'
    end
    object cdsPedidoImp_Item_ProcQTD_DOBRA: TIntegerField
      FieldName = 'QTD_DOBRA'
    end
    object cdsPedidoImp_Item_ProcNOME_PROCESSO: TStringField
      FieldName = 'NOME_PROCESSO'
      Size = 48
    end
  end
  object dsPedidoImp_Item_Proc: TDataSource
    DataSet = cdsPedidoImp_Item_Proc
    Left = 234
    Top = 611
  end
  object dspPedidoImp_Item_Proc: TDataSetProvider
    DataSet = sdsPedidoImp_Item_Proc
    Left = 192
    Top = 612
  end
  object frxPedidoImp_Item_Proc: TfrxDBDataset
    UserName = 'frxPedidoImp_Item_Proc'
    OnFirst = frxDBDataset1First
    OnNext = frxDBDataset1Next
    CloseDataSource = False
    FieldAliases.Strings = (
    ...
    DataSource = dsPedidoImp_Item_Proc
    BCDToCurrency = False
    Left = 1184
    Top = 240
  end
