...
type
  TDMCadPedido = class(TDataModule)
    ...
    sdsTitulosPend: TSQLDataSet;
    cdsTitulosPend: TClientDataSet;
    dspTitulosPend: TDataSetProvider;
    dsTitulosPend: TDataSource;
    cdsTitulosPendID: TIntegerField;
    cdsTitulosPendNUMDUPLICATA: TStringField;
    cdsTitulosPendPARCELA: TIntegerField;
    cdsTitulosPendDTEMISSAO: TDateField;
    cdsTitulosPendDTVENCIMENTO: TDateField;
    cdsTitulosPendVLR_RESTANTE: TFloatField;
    cdsTitulosPendDESCRICAO: TStringField;
    cdsTitulosPendDESCRICAO2: TStringField;
    ...
    cdsCloneItemITEM: TIntegerField;
    cdsCloneItemID_PRODUTO: TIntegerField;
    cdsCloneItemID_COR: TFMTBCDField;
    cdsCloneItemTAMANHO: TStringField;
    cdsCloneItemQTD: TFloatField;
    cdsCloneItemQTD_FATURADO: TFloatField;
    cdsCloneItemQTD_RESTANTE: TFloatField;
    cdsCloneItemQTD_CANCELADO: TFloatField;
    cdsCloneItemVLR_DESCONTO: TFloatField;
    cdsCloneItemCANCELADO: TStringField;
    cdsCloneItemDTENTREGA: TDateField;
    cdsCloneItemFATURADO: TStringField;
    cdsCloneItemDTFATURADO: TDateField;
    cdsCloneItemCOD_PRODUTO_CLIENTE: TStringField;
    cdsCloneItemTIPO: TStringField;
    cdsCloneItemUNIDADE: TStringField;
    cdsCloneItemNUMOS: TStringField;
    cdsCloneItemPERC_DESCONTO: TFloatField;
    cdsCloneItemVLR_FRETE: TFloatField;
    cdsCloneItemBASE_ICMS: TFloatField;
    cdsCloneItemVLR_ICMS: TFloatField;
    cdsCloneItemBASE_ICMSTRANSF: TFloatField;
    cdsCloneItemPERC_TRANSF: TFloatField;
    cdsCloneItemVLR_TRANSF: TFloatField;
    cdsCloneItemVLR_IPI: TFloatField;
    cdsCloneItemBASE_ICMSSIMPLES: TFloatField;
    cdsCloneItemVLR_ICMSSIMPLES: TFloatField;
    cdsCloneItemPERC_ICMSSIMPLES: TFloatField;
    cdsCloneItemBASE_ICMSSUBST: TFloatField;
    cdsCloneItemVLR_ICMSSUBST: TFloatField;
    cdsCloneItemVLR_DESCONTORATEIO: TFloatField;
    cdsCloneItemID_CFOP: TIntegerField;
    cdsCloneItemID_CSTIPI: TIntegerField;
    cdsCloneItemID_CSTICMS: TIntegerField;
    cdsCloneItemPERC_ICMS: TFloatField;
    cdsCloneItemPERC_IPI: TFloatField;
    cdsCloneItemREFERENCIA: TStringField;
    cdsCloneItemNOMEPRODUTO: TStringField;
    cdsCloneItemOBS_COMPLEMENTAR: TStringField;
    cdsCloneItemCALCULARICMSSOBREIPI: TStringField;
    cdsCloneItemVLR_UNITARIO: TFloatField;
    cdsCloneItemID_CONFIG_CFOP: TIntegerField;
    cdsCloneItemVLR_TOTAL: TFloatField;
    cdsCloneItemQTD_AFATURAR: TFloatField;
    cdsCloneItemID_VARIACAO: TIntegerField;
    cdsCloneItemOBS: TMemoField;
    cdsCloneItemPERC_TRIBICMS: TFloatField;
    cdsCloneItemID_ATELIER: TIntegerField;
    cdsCloneItemVLR_UNITARIO_ATELIER: TFloatField;
    cdsCloneItemVLR_TOTAL_ATELIER: TFloatField;
    cdsCloneItemDT_ENVIO_ATELIER: TDateField;
    cdsCloneItemDT_RETORNO_ATELIER: TDateField;
    cdsCloneItemVLR_PAGTO_ATELIER: TFloatField;
    cdsCloneItemDT_PAGTO_ATELIER: TDateField;
    cdsCloneItemAPROVADO_ORC: TStringField;
    cdsCloneItemMOTIVO_NAO_APROV: TMemoField;
    cdsCloneItemDTAPROVADO_NAO: TDateField;
    cdsCloneItemID_ORCAMENTO: TIntegerField;
    cdsCloneItemITEM_ORCAMENTO: TIntegerField;
    cdsCloneItemQTD_LIBERADA: TFloatField;
    cdsCloneItemQTD_PRODUZIDA: TFloatField;
    cdsCloneItemNUM_LOTE: TIntegerField;
    cdsCloneItemNUM_TALAO: TStringField;
    cdsCloneItemGERAR_LOTE: TStringField;
    cdsCloneItemCARIMBO: TStringField;
    cdsCloneItemDTPRODUCAO: TDateField;
    cdsCloneItemID_NCM: TIntegerField;
    cdsCloneItemTIPO_ORCAMENTO: TStringField;
    cdsCloneItemEND_FOTO: TStringField;
    cdsCloneItemITEM_CLIENTE: TIntegerField;
    cdsCloneItemQTD_PECA: TIntegerField;
    cdsCloneItemGRAVACAO_COM_ERRO: TStringField;
    cdsCloneItemQTD_FUT: TFloatField;
    cdsCloneItemITEM_COMBINACAO: TIntegerField;
    cdsCloneItemTIPO_REG: TStringField;
    cdsCloneItemID_MOVESTOQUE: TIntegerField;
    cdsCloneItemGERAR_ESTOQUE: TStringField;
    cdsCloneItemITEM_ORIGINAL: TIntegerField;
    cdsCloneItemPERC_DIFERIMENTO: TFloatField;
    cdsCloneItemVLR_ICMSDIFERIDO: TFloatField;
    cdsCloneItemTIPO_ACESSORIO: TStringField;
    cdsCloneItemCOMPRIMENTO_VOLUME: TFloatField;
    cdsCloneItemQTD_LANCAR_ESTOQUE: TFloatField;
    cdsCloneItemPERC_COMISSAO: TFloatField;
    cdsCloneItemNUM_LOTE_CONTROLE: TStringField;
    cdsCloneItemDTEXPEDICAO: TDateField;
    cdsCloneItemDTFATURA: TDateField;
    cdsCloneItemPERC_ICMS_FCP: TFloatField;
    cdsCloneItemPERC_ICMS_UF_DEST: TFloatField;
    cdsCloneItemPERC_ICMS_PARTILHA: TFloatField;
    cdsCloneItemVLR_ICMS_FCP: TFloatField;
    cdsCloneItemVLR_ICMS_UF_DEST: TFloatField;
    cdsCloneItemVLR_ICMS_UF_REMET: TFloatField;
    cdsCloneItemPERC_ICMS_INTER: TFloatField;
    cdsCloneItemCOPIAR_SELECIONADO: TStringField;
    cdsCloneItemVLR_DUPLICATA: TFloatField;
    cdsCloneItemGERAR_DUPLICATA: TStringField;
    cdsCloneItemSELECIONADO: TStringField;
    cdsCloneItemQTD_CONFERIDO: TFloatField;
    cdsCloneItemDTCONFERENCIA: TDateField;
    cdsCloneItemHRCONFERENCIA: TTimeField;
    cdsCloneItemUSUARIO_CONF: TStringField;
    cdsCloneItemVLR_ICMSFRETE: TFloatField;
    cdsCloneItemQTD_SOBRA_OC: TFloatField;
    cdsCloneItemTIPO_SERVICO: TStringField;
    cdsCloneItemID_SERVICO_INT: TIntegerField;
    cdsCloneItemNOME_SERVICO_INT: TStringField;
    cdsCloneItemPRECO_CUSTO: TFloatField;
    cdsCloneItemPERC_MARGEM: TFloatField;
    cdsCloneItemPERC_MARGEM2: TFloatField;
    cdsCloneItemID_OS_SERV: TIntegerField;
    cdsCloneItemNUM_OS_SERV: TIntegerField;
    cdsCloneItemID_SERVICO: TIntegerField;
    cdsCloneItemNUM_NOTA_ENT: TIntegerField;
    cdsCloneItemSERIE_NOTA_ENT: TStringField;
    cdsCloneItemENCERADO: TStringField;
    cdsCloneItemUNIDADE_PROD: TStringField;
    cdsCloneItemCONV_UNIDADE: TFloatField;
    cdsCloneItemTALAO_IMPRESSO: TStringField;
    cdsCloneItemOBS_ETIQUETA: TStringField;
    cdsCloneItemQTD_CAIXA: TIntegerField;
    cdsCloneItemCOD_COR_CLIENTE: TStringField;
    cdsCloneItemNOME_COR_CLIENTE: TStringField;
    cdsCloneItemTAMANHO_CLIENTE: TStringField;
    cdsCloneItemGEROU_LOTE_PROD: TStringField;
    cdsCloneItemFOTO: TStringField;
    cdsCloneItemVLR_MATERIAL: TFloatField;
    cdsCloneItemTEMPO: TFloatField;
    cdsCloneItemDTBAIXA: TDateField;
    cdsCloneItemTEMPO_REAL: TFloatField;
    cdsCloneItemVLR_UNITARIO_REAL: TFloatField;
    cdsCloneItemFATOR_CALCULO_REAL: TFloatField;
    cdsCloneItemGEROU_PED_TALAO: TStringField;
    cdsCloneItemQTD_POR_ROTULO: TIntegerField;
    cdsCloneItemTIPO_OS: TStringField;
    cdsCloneItemDIFERENCA_ICMS: TStringField;
    cdsCloneItemCAIXINHA: TStringField;
    cdsCloneItemBASE_IPI: TFloatField;
    cdsCloneItemATUALIZA_PRECO_CUSTO: TStringField;
    cdsCloneItemFABRICA: TStringField;
    cdsCloneItemENCOMENDA: TStringField;
    cdsCloneItemAPROVADO_ITEM: TStringField;
    cdsCloneItemDRAWBACK: TStringField;
    cdsCloneItemID_PROCESSO: TIntegerField;
    cdsCloneItemPRECO_COR: TFloatField;
    cdsCloneItemCODCFOP: TStringField;
    cdsCloneItemCOD_CST: TStringField;
    cdsCloneItemCOD_IPI: TStringField;
    cdsCloneItemNCM: TStringField;
