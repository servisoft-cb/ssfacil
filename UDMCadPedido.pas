...
type
  TDMCadPedido = class(TDataModule)
    ...
    sdsItens_Consulta: TSQLDataSet;
    dspItens_Consulta: TDataSetProvider;
    cdsItens_Consulta: TClientDataSet;
    dsItens_Consulta: TDataSource;
    cdsItens_ConsultaID: TIntegerField;
    cdsItens_ConsultaITEM: TIntegerField;
    cdsItens_ConsultaID_PRODUTO: TIntegerField;
    cdsItens_ConsultaREFERENCIA: TStringField;
    cdsItens_ConsultaNOMEPRODUTO: TStringField;
    cdsItens_ConsultaDTENTREGA: TDateField;
    cdsItens_ConsultaQTD: TFloatField;
    ...
    mOrcamento_ItensComprimento: TFloatField;
    mOrcamento_ItensLargura: TFloatField;
    cdsOrcamento_ItensCOMPRIMENTO: TFloatField;
    cdsOrcamento_ItensLARGURA: TFloatField;
    cdsOrcamento_ItensDIAMETRO: TFloatField;
    cdsOrcamento_ItensDIAMETRO_EXT: TFloatField;
    cdsOrcamento_ItensDIAMETRO_INT: TFloatField;
    cdsOrcamento_ItensPAREDE: TFloatField;
    cdsOrcamento_ItensDESCRICAO_TIPO: TStringField;
    mOrcamento_ItensDiametro: TFloatField;
    mOrcamento_ItensDiametro_Ext: TFloatField;
    mOrcamento_ItensDiametro_Int: TFloatField;
    mOrcamento_ItensParede: TFloatField;
    ...
    procedure cdsPedido_Item_ProcessoCalcFields(DataSet: TDataSet);
  private
  ...
  public
    ...
    vTipo_Rel_Ped: String; //P=Produ��o  R=Romaneio Expedi��o
...
procedure TDMCadPedido.prc_Localizar(ID: Integer); //-1 � para inclus�o
begin
  cdsPedido.Close;
...
begin
  ...
  begin
    if ((Copy(vCodigo,1,1) <> '5') and (Copy(vCodigo,1,1) <> '6') and (Copy(vCodigo,1,1) <> '7')) then
      vMsgErroAux := vMsgErroAux + #13 + 'Natureza � de sa�da!'
    else
    ...
    begin
      if (vSiglaUF <> cdsFilialUF.AsString) and ((Copy(vCodigo,1,1) = '1') or (Copy(vCodigo,1,1) = '5')) then
        vMsgErroAux := vMsgErroAux + #13 + 'Natureza inv�lida para o estado!'
      else
...
procedure TDMCadPedido.cdsPedido_Item_ProcessoCalcFields(
  DataSet: TDataSet);
begin
  cdsPedido_Item_ProcessoclNome2.AsString := '';
  if cdsPedido_Item_ProcessoID_PROCESSO.AsInteger > 0 then
  begin
    qProcesso.Close;
    qProcesso.ParamByName('ID').AsInteger := cdsPedido_Item_ProcessoID_PROCESSO.AsInteger;
    qProcesso.Open;
    cdsPedido_Item_ProcessoclNome2.AsString := qProcessoNOME.AsString;
    if qProcessoUSAR_QTD_DOBRA.AsString = 'S' then
      cdsPedido_Item_ProcessoclNome2.AsString := qProcessoNOME.AsString + ' Qtd.: ' + cdsPedido_Item_ProcessoQTD_DOBRA.AsString;
  end;
end;
