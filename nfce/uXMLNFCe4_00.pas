...
begin
  ...
  DetXML.Imposto.ICMS.ICMS60.VICMSSubstituto := Replace(FormatFloat('0.00',fDMNFCe.mItensNFeVlr_Icms_Substituto.AsFloat ) ,',','.');
...
begin
  ...
  DetXML.Imposto.ICMS.ICMSSN500.VICMSSubstituto := Replace(FormatFloat('0.00',0) ,',','.');
