object frmConsMaterial_Nec: TfrmConsMaterial_Nec
  Left = 295
  Top = 152
  BorderStyle = bsSingle
  Caption = 'frmConsMaterial_Nec'
  ClientHeight = 441
  ClientWidth = 912
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label3: TLabel
      ...
      Caption = 'Data In'#237'cio Remessa:'
    end
    ...
    object Label6: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = 'Data In'#237'cio Pedido:'
    end
    ...
    object RxDBLookupCombo1: TRxDBLookupCombo
      ...
      LookupSource = DMConsMaterial_Nec.dsFilial
      ParentCtl3D = False
      TabOrder = 0
    end
  ...
  object SMDBGrid1: TSMDBGrid
    ...
    Align = alClient
    Ctl3D = False
    DataSource = DMConsMaterial_Nec.dsMaterial_Nec
