...
type
  TDMConsEstoque = class(TDataModule)
    ...
    dsEstoque_De_Terc: TDataSource;
    sdsEstoque_Em_Terc: TSQLDataSet;
    dspEstoque_Em_Terc: TDataSetProvider;
    cdsEstoque_Em_Terc: TClientDataSet;
    dsEstoque_Em_Terc: TDataSource;
    frxEstoque_Mov: TfrxDBDataset;
    cdsEstoque_AtualUNIDADE: TStringField;
    frxEstoque_Atual: TfrxDBDataset;
    mNCM: TClientDataSet;
    dsmNCM: TDataSource;
    mNCMID_NCM: TIntegerField;
    mNCMNCM: TStringField;
    mNCMNome: TStringField;
    mNCMQtd: TFloatField;
    cdsEstoque_AtualID_NCM: TIntegerField;
    cdsEstoque_AtualNCM: TStringField;
    cdsEstoque_AtualNOME_NCM: TStringField;
    frxmNCM: TfrxDBDataset;
    ...
    sdsEstoque_De_Terc_Pes: TSQLDataSet;
    dspEstoque_De_Terc_Pes: TDataSetProvider;
    cdsEstoque_De_Terc_Pes: TClientDataSet;
    dsEstoque_De_Terc_Pes: TDataSource;
    sdsEstoque_Em_Terc_Pes: TSQLDataSet;
    dspEstoque_Em_Terc_Pes: TDataSetProvider;
    cdsEstoque_Em_Terc_Pes: TClientDataSet;
    dsEstoque_Em_Terc_Pes: TDataSource;
    cdsEstoque_AtualID_PRODUTO: TIntegerField;
    cdsBalancoTIPO_REG: TStringField;
    cdsEstoque_De_TercID_PRODUTO: TIntegerField;
    cdsEstoque_De_TercREFERENCIA: TStringField;
    cdsEstoque_De_TercQTDRESTANTE: TFloatField;
    cdsEstoque_De_TercVLR_TOTAL: TFloatField;
    cdsEstoque_De_TercUNIDADE: TStringField;
    cdsEstoque_De_TercNOME_COMBINACAO: TStringField;
    cdsEstoque_De_TercDESC_TIPO_SPED: TStringField;
    cdsEstoque_De_Terc_PesID_PRODUTO: TIntegerField;
    cdsEstoque_De_Terc_PesREFERENCIA: TStringField;
    cdsEstoque_De_Terc_PesQTDRESTANTE: TFloatField;
    cdsEstoque_De_Terc_PesVLR_TOTAL: TFloatField;
    cdsEstoque_De_Terc_PesUNIDADE: TStringField;
    cdsEstoque_De_Terc_PesNOME_COMBINACAO: TStringField;
    cdsEstoque_De_Terc_PesDESC_TIPO_SPED: TStringField;
    cdsEstoque_De_Terc_PesID_TERCEIRO: TIntegerField;
    cdsEstoque_De_Terc_PesNOME_TERCEIRO: TStringField;
    cdsEstoque_De_Terc_PesNOME_PRODUTO: TStringField;
    cdsEstoque_De_TercTAMANHO: TStringField;
    cdsEstoque_De_Terc_PesTAMANHO: TStringField;
    cdsEstoque_Em_TercID_PRODUTO: TIntegerField;
    cdsEstoque_Em_TercREFERENCIA: TStringField;
    cdsEstoque_Em_TercQTDRESTANTE: TFloatField;
    cdsEstoque_Em_TercVLR_TOTAL: TFloatField;
    cdsEstoque_Em_TercUNIDADE: TStringField;
    cdsEstoque_Em_TercNOME_COMBINACAO: TStringField;
    cdsEstoque_Em_TercTAMANHO: TStringField;
    cdsEstoque_Em_TercDESC_TIPO_SPED: TStringField;
    cdsEstoque_Em_Terc_PesID_PRODUTO: TIntegerField;
    cdsEstoque_Em_Terc_PesNOME_PRODUTO: TStringField;
    cdsEstoque_Em_Terc_PesREFERENCIA: TStringField;
    cdsEstoque_Em_Terc_PesQTDRESTANTE: TFloatField;
    cdsEstoque_Em_Terc_PesVLR_TOTAL: TFloatField;
    cdsEstoque_Em_Terc_PesUNIDADE: TStringField;
    cdsEstoque_Em_Terc_PesNOME_COMBINACAO: TStringField;
    cdsEstoque_Em_Terc_PesID_TERCEIRO: TIntegerField;
    cdsEstoque_Em_Terc_PesNOME_TERCEIRO: TStringField;
    cdsEstoque_Em_Terc_PesTAMANHO: TStringField;
    ...
    mEstoque_CentroCustoNome_Grupo: TStringField;
    mEstoque_CentroCustoQSai: TFloatField;
    mEstoque_CentroCustoObs: TStringField;
    mEstoque_CentroCustoQEnt: TFloatField;
    mEstoque_CentroCustoVlrTotal: TFloatField;
    mEstoque_CentroCustoCodigo_CentroCusto: TStringField;
    mEstoque_CentroCustoNome_CentroCusto: TStringField;
    frxGrupoCentroCusto: TfrxDBDataset;
    mEstoque_CentroCustoCodigo_Superior: TStringField;
    mEstoque_CentroCustoNome_Superior: TStringField;
    qAltPreco: TSQLQuery;
    qAltPrecoALT_CUSTO: TDateField;
    sdsCompras: TSQLDataSet;
    dspCompras: TDataSetProvider;
    cdsCompras: TClientDataSet;
    dsCompras: TDataSource;
    cdsComprasDTMOVIMENTO: TDateField;
    cdsComprasNUMNOTA: TIntegerField;
    cdsComprasNOME_COR: TStringField;
    cdsComprasQTD: TFloatField;
    cdsComprasVLR_UNITARIO: TFloatField;
    cdsComprasVLR_FRETE: TFloatField;
    ...
    cdsEstoque2ENTRADA: TFloatField;
    cdsEstoque2SAIDA: TFloatField;
    cdsEstoque2SALDO: TFloatField;
    cdsEstoque2ESPESSURA: TFloatField;
    cdsEstoque2FILIAL: TIntegerField;
    cdsEstoque2NOMEPRODUTO: TStringField;
    cdsEstoque2ID: TIntegerField;
    cdsEstoque2REFERENCIA: TStringField;
