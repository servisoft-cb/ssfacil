object frmGerar_Lote_Calc: TfrmGerar_Lote_Calc
  ...
  object RzPageControl2: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object pnlPesquisa: TPanel
        ...
        object Label1: TLabel
          ...
          Width = 117
          Height = 13
          Caption = 'N'#227'o gerado tal'#227'o auxiliar'
        end
        ...
        object btnGerarTalao_Aux: TNxButton
          Left = 516
          Top = 73
          Width = 175
          Height = 30
          ...
          TabOrder = 9
          Transparent = True
          OnClick = btnGerarTalao_AuxClick
        end
        object Edit3: TEdit
          Left = 495
          Top = 3
      ...
      object SMDBGrid2: TSMDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Tal'#227'o auxiliar gerado'
            Title.Color = 13041606
            Width = 87
            Visible = True
          end>
    ...
    object TS_Gerar: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object RzGroupBox2: TRzGroupBox
          ...
          BorderOuter = fsBump
          Caption = ' Dados para Gravar na OP '
          Color = 16771255
          Ctl3D = True
          FlatColor = clNavy
    ...
    object TS_Auxiliar: TRzTabSheet
      Caption = 'Lotes Auxiliares'
      object Panel3: TPanel
        ...
        object cbOpcaoTalaoAux: TNxComboBox
          Left = 658
          Top = 4
          Width = 132
          Height = 21
          ...
          BevelOuter = bvSpace
          TabOrder = 5
          Text = 'Pendente (na f'#225'brica)'
          ReadOnly = True
          OnChange = cbOpcaoTalaoAuxChange
          HideFocus = False
          Style = dsDropDownList
          AutoCompleteDelay = 0
          ItemIndex = 0
          Items.Strings = (
            'Pendente (na f'#225'brica)'
            'Pendente (no atelier)'
            'Entregue'
            'Ambos')
        end
        ...
        object NxComboBox2: TNxComboBox
          ...
          ItemIndex = 0
          Items.Strings = (
            'Dt.Saida Para o Atelier:'
            'Dt.Retorno do Atelier:')
        end
        object btnConsultar_Talao_Aux: TNxButton
          Left = 76
          Top = 83
          Width = 175
          Height = 30
          ...
          TabOrder = 11
          Transparent = True
          OnClick = btnConsultar_Talao_AuxClick
        end
        ...
        object RxDBLookupCombo3: TRxDBLookupCombo
          ...
          LookupField = 'CODIGO'
          LookupDisplay = 'NOME'
          LookupSource = DMCadLote.dsAtelier
          ParentCtl3D = False
          TabOrder = 0
        end
        object RxDBLookupCombo4: TRxDBLookupCombo
          ...
          LookupField = 'ID'
          LookupDisplay = 'NOME'
          LookupSource = DMCadLote.dsSetor
          ParentCtl3D = False
          TabOrder = 1
        end
        object btnImpTalao_Aux: TNxButton
          Left = 252
          Top = 83
          Width = 153
          Height = 30
      ...
      object VDBGrid2: TVDBGrid
        ...
        Align = alBottom
        Ctl3D = False
        DataSource = DMCadLote.dsConsulta_Talao_Aux_Tam
        FixedColor = 16765606
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
  ...
  object PopupMenu1: TPopupMenu
    ...
    object FolhaResumo1: TMenuItem
      Caption = 'Folha Resumo'
      OnClick = FolhaResumo1Click
    end
    ...
    object Personalizado1: TMenuItem
      ...
      object Personalizado11: TMenuItem
        Caption = 'Personalizado 1'
        OnClick = Personalizado11Click
      end
    end
  end
