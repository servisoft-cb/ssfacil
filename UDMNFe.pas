...
type
  TDMNFe = class(TDataModule)
    ...
    qNCM_Lei: TSQLQuery;
    qNCM_LeiID: TIntegerField;
    qNCM_LeiITEM: TIntegerField;
    qNCM_LeiID_CFOP: TIntegerField;
    qNCM_LeiID_CST_ICM: TIntegerField;
    qNCM_LeiID_LEI: TIntegerField;
    qNCM_LeiCOMPLEMENTO: TStringField;
    qNCM_LeiOBS: TStringField;
    qParametros_NFeUSA_LEI_NCM: TStringField;
    mAuxDadosNFeComplemento: TStringField;
    sdsItensNCM: TSQLDataSet;
    dspItensNCM: TDataSetProvider;
    cdsItensNCM: TClientDataSet;
...
procedure TDMNFe.prc_Localizar(ID: Integer); //-1 é para inclusão
begin
  cdsNFe_Email.Close;
