object frmCadAjuste_Preco: TfrmCadAjuste_Preco
  Left = 177
  Top = 38
  Width = 945
  Height = 669
  Caption = 'Ajuste Pre'#231'o'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Consulta: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMCadAjuste_Preco.dsConsulta
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object pnlCadastro: TPanel
        ...
        object rxcbTipo_ES: TRxDBComboBox
          ...
          Style = csDropDownList
          DataField = 'TIPO'
          DataSource = DMCadAjuste_Preco.dsAjuste_Preco
          EnableValues = True
          ItemHeight = 13
          Items.Strings = (
            'Aumento'
        ...
        object SMDBGrid2: TSMDBGrid
          ...
          Align = alBottom
          Ctl3D = False
          DataSource = DMCadAjuste_Preco.dsAjuste_Preco_Itens
          Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
          ParentCtl3D = False
          ReadOnly = True
          TabOrder = 7
