...
type
  TdmCadProduto = class(TDataModule)
    ...
    cdsFichaTecnicaID_MATERIAL: TIntegerField;
    ...
    cdsFichaTecnicaID_COR_MAT: TFMTBCDField;
    ...
    sdsProdutoAplicacaoID: TIntegerField;
    sdsProdutoAplicacaoITEM: TIntegerField;
    sdsProdutoAplicacaoID_MARCA: TIntegerField;
    sdsProdutoAplicacaoAPLICACAO: TStringField;
    cdsProdutosdsProdutoAplicacao: TDataSetField;
