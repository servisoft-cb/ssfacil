...
type
  TfMenu = class(TForm)
    ...
    ConsultaNotasdeBeneficiamentoEstoqueDeTerceirosManual1: TMenuItem;
    ConsultaPedidoxMateriaisTerceiros1: TMenuItem;
    ConsultaNotas1: TMenuItem;
    ConsultaComprasNotas1: TMenuItem;
    ConsultaOrdemdeCompra1: TMenuItem;
    ConsultaComprasServioContaOramento1: TMenuItem;
    ConsultaMateriaisPorOrdemdeProduo1: TMenuItem;
    ConsultaProdutosST1: TMenuItem;
    BaixasManuais2: TMenuItem;
    BaixaOrdemdeCompraManual1: TMenuItem;
    BaixaNotadeBeneficiamentoEstoqueDeTerceiro1: TMenuItem;
    N16: TMenuItem;
