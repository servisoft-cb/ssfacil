object dmCadProduto: TdmCadProduto
  ...
  object sdsProduto_Consulta: TSQLDataSet
    ...
    CommandText = 
      ...
      ' BY ITEM DESC) NUM_SERIE, PRO.FILIAL'#13#10'from PRODUTO PRO'#13#10'left joi' +
  ...
  object cdsProduto_Consulta: TClientDataSet
    ...
    object cdsProduto_ConsultaGERAR_ST: TStringField
      FieldName = 'GERAR_ST'
      FixedChar = True
      Size = 1
    end
    ...
    object cdsProduto_ConsultaFILIAL: TIntegerField
      FieldName = 'FILIAL'
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 43858.468237291700000000
    ReportOptions.LastChange = 43858.552499039350000000
  ...
  object frxProdutoConsulta: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'TIPO_REG_DESCRICAO=TIPO_REG_DESCRICAO'
      'AUTOR=AUTOR'
      ...
      'CONT_POSSUIPRECO=CONT_POSSUIPRECO'
      'DTCAD=DTCAD'
      'NOME_LINHA=NOME_LINHA'
      'GERAR_ST=GERAR_ST'
      'QTD_ESTOQUE=QTD_ESTOQUE'
      'TIPO_MAT=TIPO_MAT'
      'TIPO_ALGODAO=TIPO_ALGODAO'
      'MEDIDA=MEDIDA')
    DataSource = dsProduto_Consulta
    BCDToCurrency = False
    Left = 1116
    Top = 587
  end
  ...
  object sdsProduto_CA: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT *'#13#10'FROM PRODUTO_CA'#13#10'WHERE ID = :ID'#13#10
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 682
    Top = 607
    object sdsProduto_CAID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sdsProduto_CAITEM: TIntegerField
      FieldName = 'ITEM'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sdsProduto_CANUM_CA: TStringField
      FieldName = 'NUM_CA'
    end
    object sdsProduto_CADATA: TDateField
      FieldName = 'DATA'
    end
  end
  object dspProduto_CA: TDataSetProvider
    DataSet = sdsProduto_CA
    UpdateMode = upWhereKeyOnly
    OnUpdateError = dspProdutoUpdateError
    Left = 714
    Top = 607
  end
  object cdsProduto_CA: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'ID;ITEM'
    Params = <>
    ProviderName = 'dspProduto_CA'
    Left = 742
    Top = 607
    object cdsProduto_CAID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsProduto_CAITEM: TIntegerField
      FieldName = 'ITEM'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsProduto_CANUM_CA: TStringField
      FieldName = 'NUM_CA'
    end
    object cdsProduto_CADATA: TDateField
      FieldName = 'DATA'
    end
  end
  object dsProduto_CA: TDataSource
  ...
  object cdsProdutoAplicacao: TClientDataSet
    Aggregates = <>
    DataSetField = cdsProdutosdsProdutoAplicacao
    Params = <>
    Left = 992
    Top = 2
