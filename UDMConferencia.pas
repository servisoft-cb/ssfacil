...
type
  TDMConferencia = class(TDataModule)
    ...
    cdsConsPedido_Item_ProcCOD_BARRA: TStringField;
    ...
    cdsConsPedido_Item_ProcID_PROCESSO: TIntegerField;
    cdsConsPedido_Item_ProcITEM_PROCESSO: TIntegerField;
    cdsConsPedido_Item_ProcNOME_PROCESSO: TStringField;
    cdsConsPedido_Item_ProcDTENTRADA: TDateField;
    cdsConsPedido_Item_ProcDTBAIXA: TDateField;
    cdsConsPedido_Item_ProcHRENTRADA: TTimeField;
    cdsConsPedido_Item_ProcHRSAIDA: TTimeField;
