...
type
  TDMGerar_EDI = class(TDataModule)
    ...
    mOCobs: TMemoField;
    mOCcodigo: TStringField;
    mOCnome: TStringField;
    mOCcnpj: TStringField;
    mOCitem: TDataSetField;
    mOCItenssequencia: TStringField;
    mOCItenscodigo: TStringField;
    mOCItensdescricao: TStringField;
    mOCItensqtde: TStringField;
    mOCItensunidade: TStringField;
    mOCItensprecounitario: TStringField;
    mOCItensentrega: TDataSetField;
