object frmCadDocEstoque: TfrmCadDocEstoque
  Left = 177
  Top = 38
  Width = 945
  Height = 669
  Caption = 'Documento de Ajuste do Estoque'
  Color = clBtnFace
      ...
      object pnlTipo: TPanel
        ...
        object rxcbTipo_Reg: TRxDBComboBox
          ...
          Values.Strings = (
            ...
            'T'
            'P')
          OnChange = rxcbTipo_RegChange
          OnExit = rxcbTipo_RegExit
        end
      end
