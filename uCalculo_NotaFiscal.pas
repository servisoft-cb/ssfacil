...
uses
  ...
  procedure prc_Calcular_Desconto_Novo(fDMCadNotaFiscal: TDMCadNotaFiscal;Repetir: Boolean; vDescRepetir: Currency);
...
begin
  ...
  if (fDMCadNotaFiscal.cdsNotaFiscal_Itens.IsEmpty) or (fDMCadNotaFiscal.cdsNotaFiscal_Itens.RecordCount <= 0)
    and not(Repetir) then
    prc_Zera_Campos_Nota(fDMCadNotaFiscal);
  ...
  begin
    ...
    fDMCadNotaFiscal.cdsNotaFiscalVLR_IPI_DEVOL.AsFloat      := 0;
    fDMCadNotaFiscal.cdsNotaFiscalBASE_IPI.AsFloat           := 0;
    //16/01/2020
    fDMCadNotaFiscal.cdsNotaFiscalBASE_COFINS.AsFloat := 0;
    fDMCadNotaFiscal.cdsNotaFiscalBASE_PIS.AsFloat    := 0;
    //*********************
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (vContador <= 0) and (StrToFloat(FormatFloat('0.00',vDesconto_Nota)) > 0) then
        begin
          vDesconto_Rateio := StrToFloat(FormatFloat('0.00',vDesconto_Rateio + vDesconto_Nota));
          vDesconto_Nota := StrToFloat(FormatFloat('0.00',0));
        end;
      end;
    end
    ...
    fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_DESCONTORATEIO.AsFloat := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_DESCONTORATEIO.AsFloat +
                                                                      vDesconto_Rateio));
    ...
    if (fDMCadNotaFiscal.cdsNotaFiscalNFEFINALIDADE.AsString = '4') and (fDMCadNotaFiscal.cdsFilialCALCULAR_IPI.AsString <> 'S') then
      fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_IPI_DEVOL.AsFloat := fnc_Calcular_IPI_Novo(fDMCadNotaFiscal, fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_TOTAL.AsFloat, vDescAux,fDMCadNotaFiscal.cdsNotaFiscal_ItensPERC_IPI.AsFloat)
    else
    ...
    if StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_IPI_DEVOL.AsFloat)) > 0 then
      prc_Calcular_ICMS_Novo(fDMCadNotaFiscal, fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_TOTAL.AsFloat,vDescAux,fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_IPI_DEVOL.AsFloat,
    ...
    prc_Calcular_ICMS_Efet(fDMCadNotaFiscal);
    ...
    if Repetir then
    begin
      fDMCadNotaFiscal.cdsNotaFiscalVLR_ITENS.AsCurrency := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_ITENS.AsCurrency - vDescRepetir));
    end
    else
    begin
      fDMCadNotaFiscal.cdsNotaFiscalVLR_ITENS.AsCurrency := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_ITENS.AsCurrency -
                                                              vDescontoItem_Total));
      fDMCadNotaFiscal.cdsNotaFiscalBASE_ICMS.AsCurrency := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_ICMS.AsCurrency +
                                                              fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_ICMS.AsCurrency));
      ...
      //09/01/2019
      fDMCadNotaFiscal.cdsNotaFiscalVLR_IPI_DEVOL.AsCurrency := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_IPI_DEVOL.AsCurrency + fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_IPI_DEVOL.AsCurrency));
      //16/01/2020
      fDMCadNotaFiscal.cdsNotaFiscalBASE_PIS.AsFloat    := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_PIS.AsFloat + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_PIS.AsFloat));
      fDMCadNotaFiscal.cdsNotaFiscalBASE_COFINS.AsFloat := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_COFINS.AsFloat + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_COFINS.AsFloat));
      //**********
    ...
    //21/01/2019
    fDMCadNotaFiscal.cdsNotaFiscalBASE_FCP_ST.AsFloat := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_FCP_ST.AsFloat + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_FCP_ST.AsFloat));
    fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsFloat  := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsFloat + fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_FCP_ST.AsFloat));
    //**************
  ...
  if (StrToFloat(FormatFloat('0.00',vDesconto_Nota)) > 0)
    ...
    begin
      vDescRepetir := StrToFloat(FormatFloat('0.00',vDesconto_Nota));
      prc_Calcular_Desconto_Novo(fDMCadNotaFiscal, True, vDescRepetir);
    end;
  ...
  begin
    fDMCadNotaFiscal.cdsNotaFiscalVLR_NOTA.AsFloat := fDMCadNotaFiscal.cdsNotaFiscalVLR_NOTA.AsFloat + fDMCadNotaFiscal.cdsNotaFiscalVLR_FRETE.AsFloat
                                         ...
                                         + fDMCadNotaFiscal.cdsNotaFiscalVLR_IPI_DEVOL.AsFloat  //09/01/2019
                                         + fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsFloat; //21/01/2019
  end;
...
begin
  ...
  //**************
  //16/01/2020
  fDMCadNotaFiscal.cdsNotaFiscalBASE_PIS.AsCurrency       := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_PIS.AsCurrency + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_IPI.AsCurrency));
  fDMCadNotaFiscal.cdsNotaFiscalBASE_COFINS.AsCurrency    := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_COFINS.AsCurrency + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_COFINS.AsCurrency));
  //*****************
  ...
  //21/01/2019
  fDMCadNotaFiscal.cdsNotaFiscalBASE_FCP_ST.AsCurrency := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_FCP_ST.AsCurrency + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_FCP_ST.AsCurrency));
  fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsCurrency  := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsCurrency + fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_FCP_ST.AsCurrency));
  //*******************
  ...
  if (copy(fDMCadNotaFiscal.cdsCFOPCODCFOP.AsString,1,1) = '3') and (StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_ICMS.AsFloat)) > 0) then
    ...
    fDMCadNotaFiscal.cdsNotaFiscalVLR_NOTA.AsFloat := fDMCadNotaFiscal.cdsNotaFiscalVLR_NOTA.AsFloat + fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_FRETE.AsFloat
                                   ...
                                   - vVlrIPIAnt - vVlrIPIDevolAnt //09/01/2019
                                   - vVlrFCPSTAnt; //21/01/2019
  ...
  fDMCadNotaFiscal.cdsNotaFiscalBASE_PIS.AsFloat := fDMCadNotaFiscal.cdsNotaFiscalBASE_PIS.AsFloat + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_PIS.AsFloat;
  fDMCadNotaFiscal.cdsNotaFiscalBASE_COFINS.AsFloat := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalBASE_COFINS.AsFloat + fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_COFINS.AsFloat));
...
begin
  ...
  if fDMCadNotaFiscal.cdsFilialDESC_ICMS_PIS_COFINS.AsString = 'S' then
    vBaseAux := StrToFloat(FormatFloat('0.00',vBaseAux - fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_ICMS.AsFloat));
...
begin
  ...
  begin
    ...
    if fDMCadNotaFiscal.cdsCondPgtoIMPOSTOS.AsString = 'U' then
      vVlrParc_Ult := StrToFloat(FormatFloat('0.00',vVlrParc_Ult + fDMCadNotaFiscal.cdsNotaFiscalVLR_IPI.AsFloat + fDMCadNotaFiscal.cdsNotaFiscalVLR_ICMSSUBST.AsFloat + fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsFloat));
    vVlrImposto := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_IPI.AsFloat + fDMCadNotaFiscal.cdsNotaFiscalVLR_ICMSSUBST.AsFloat + fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsFloat));
...
begin
  ...
  //21/01/2019  Foi incluido para controlar o cálculo da FCP quando tem ST
  if fDMCadNotaFiscal.cdsNotaFiscal_ItensID_NCM.AsInteger <> fDMCadNotaFiscal.cdsTab_NCMID.AsInteger then
    fDMCadNotaFiscal.cdsTab_NCM.Locate('ID',fDMCadNotaFiscal.cdsNotaFiscal_ItensID_NCM.AsInteger,[loCaseInsensitive]);

  if (StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensPERC_FCP_ST.AsFloat)) <= 0) or
  ...
  begin
    fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_FCP_ST.AsFloat  := StrToFloat(FormatFloat('0.00',0));
    fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_FCP_ST.AsFloat :=StrToFloat(FormatFloat('0.00',0));
  end;
  ...
  if (StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensPERC_ICMS_FCP.AsFloat)) <= 0) and
  ...
  if StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensPERC_ICMS_FCP.AsFloat)) > 0 then
    ...
    fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_ICMS_FCP.AsFloat := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_ICMS_FCP.AsFloat
                                                              * fDMCadNotaFiscal.cdsNotaFiscal_ItensPERC_ICMS_FCP.AsFloat / 100));
  if StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensPERC_FCP_ST.AsFloat)) > 0 then
    fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_FCP_ST.AsFloat := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_FCP_ST.AsFloat
                                                            * fDMCadNotaFiscal.cdsNotaFiscal_ItensPERC_FCP_ST.AsFloat / 100));
...
begin
  ...
  begin                                           
    ...
    begin
      ...
      if StrToFloat(FormatFloat('0.00000',fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_UNITARIO.AsFloat)) <> StrToFloat(FormatFloat('0.00000',fDMCadNotaFiscal.cdsProduto_CombPRECO_CUSTO.AsFloat)) then
      begin
        if (fDMCadNotaFiscal.qParametros_NTEATUALIZA_PRECO_MAIOR.AsString = 'S')
          and (StrToFloat(FormatFloat('0.00000',fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_UNITARIO.AsFloat)) > StrToFloat(FormatFloat('0.00000',fDMCadNotaFiscal.cdsProduto_CombPRECO_CUSTO.AsFloat))) then
        begin
          fDMCadNotaFiscal.cdsProduto_Comb.Edit;
          fDMCadNotaFiscal.cdsProduto_CombPRECO_CUSTO.AsFloat := StrToFloat(FormatFloat('0.00000',fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_UNITARIO.AsFloat));
        end;
        if (trim(fDMCadNotaFiscal.qParametros_NTEATUALIZA_PRECO_MAIOR.AsString) <> 'S') then
        begin
          fDMCadNotaFiscal.cdsProduto_Comb.Edit;
          fDMCadNotaFiscal.cdsProduto_CombPRECO_CUSTO.AsFloat := StrToFloat(FormatFloat('0.00000',fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_UNITARIO.AsFloat));
        end;
        if fDMCadNotaFiscal.cdsProduto_Comb.State in [dsEdit] then
        begin
          fDMCadNotaFiscal.cdsProduto_Comb.Post;
          fDMCadNotaFiscal.cdsProduto_Comb.ApplyUpdates(0);
        end;
      end;
    end
    else
...
begin
  ...
  begin
    vBaseSTRet := StrToFloat(FormatFloat('0.0000',fDMCadNotaFiscal.qProdSTBASE_ST_RET.AsFloat));
    vVlrSTRet  := StrToFloat(FormatFloat('0.0000',fDMCadNotaFiscal.qProdSTVLR_ST_RET.AsFloat));
  end
  else
  begin
  ...
  fDMCadNotaFiscal.cdsNotaFiscal_ItensBASE_ICMSSUBST_RET.AsFloat     := StrToFloat(FormatFloat('0.00',vBaseSTRet * fDMCadNotaFiscal.cdsNotaFiscal_ItensQTD.AsFloat));
  fDMCadNotaFiscal.cdsNotaFiscal_ItensVLR_ICMSSUBST_RET.AsFloat      := StrToFloat(FormatFloat('0.00',vVlrSTRet * fDMCadNotaFiscal.cdsNotaFiscal_ItensQTD.AsFloat));
...
begin
  ...
  if StrToFloat(FormatFloat('0.0000',fDMCadNotaFiscal.cdsProdutoPERC_REDUCAOICMS.AsFloat)) > 0 then
    vPerc_Red := StrToFloat(FormatFloat('0.0000',100 - fDMCadNotaFiscal.cdsProdutoPERC_REDUCAOICMS.AsFloat));
  ...
  begin
    vPerc_Interno := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.qProduto_UFPERC_ICMS_INTERNO.AsFloat));
    if ((fDMCadNotaFiscal.qProduto_UFPERC_REDUCAO_ICMS.AsFloat > 0) and (fDMCadNotaFiscal.qProduto_UFPERC_REDUCAO_ICMS.AsFloat < 100)) then
      vPerc_Red := StrToFloat(FormatFloat('0.00',100 - fDMCadNotaFiscal.qProduto_UFPERC_REDUCAO_ICMS.AsFloat));
  end;
  if (StrToFloat(FormatFloat('0.0000',vPerc_Red)) <= 0) then
  begin
    if fDMCadNotaFiscal.cdsTab_NCMID.AsInteger <> fDMCadNotaFiscal.cdsNotaFiscal_ItensID_NCM.AsInteger then
      fDMCadNotaFiscal.cdsTab_NCM.Locate('ID',fDMCadNotaFiscal.cdsNotaFiscal_ItensID_NCM.AsInteger,[loCaseInsensitive]);
    if (StrToFloat(FormatFloat('0.0000',fDMCadNotaFiscal.cdsTab_NCMPERC_BASE_ICMS.AsFloat)) > 0) and
  ...
  begin
    ...
    if StrToFloat(FormatFloat('0.000',fDMCadNotaFiscal.qNCM_UFPERC_ICMS_INTERNO.AsFloat)) > 0 then
      vPerc_Interno := fDMCadNotaFiscal.qNCM_UFPERC_ICMS_INTERNO.AsFloat;
  end;
  if StrToFloat(FormatFloat('0.00',vPerc_Interno)) <= 0 then
  begin
...
procedure prc_Zera_Campos_Nota;
begin
  fDMCadNotaFiscal.cdsNotaFiscalVLR_ADUANEIRA.AsFloat          := 0;
  fDMCadNotaFiscal.cdsNotaFiscalVLR_COFINS.AsFloat             := 0;
  fDMCadNotaFiscal.cdsNotaFiscalVLR_PIS.AsFloat                := 0;
