...
uses
  Classes, SysUtils, Dialogs, SqlExpr, DmdDatabase, UDMCadNotaFiscal, uDMNFe, enviNFe_v400, DateUtils, Variants;

  procedure prc_Gerar_XML_400(fDMCadNotaFiscal: TDMCadNotaFiscal ; fDMNFe : TDMNFe ; AStrings: TStrings);
...
begin
  ...
  //4.00
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat)) > 0 then
  begin
    DetXML.Imposto.ICMS.ICMS00.PFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS00.VFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat) ,',','.');
  end;
  //***********
end;
...
begin
  ...
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat)) > 0 then
  begin
    DetXML.Imposto.ICMS.ICMS10.VBCFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS10.PFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS10.VFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat) ,',','.');
  end;
  //***********
  ...
  begin
    DetXML.Imposto.ICMS.ICMS10.VBCFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS10.PFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS10.VFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***********
end;
...
begin
  ...
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat)) > 0 then
  begin
    DetXML.Imposto.ICMS.ICMS20.VBCFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS20.PFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS20.VFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat) ,',','.');
  end;
  //***********
...
begin
  ...
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat)) > 0 then
  begin
    DetXML.Imposto.ICMS.ICMS30.VBCFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS30.PFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS30.VFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***********
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVlrIcmsDesonerado.AsFloat)) > 0 then
  begin
...
begin
  ...
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat)) > 0 then
  begin
    DetXML.Imposto.ICMS.ICMS51.VBCFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS51.PFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS51.VFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat) ,',','.');
  end;
  //***********
end;
...
begin
  ...
  //26/02/2019
  DetXML.Imposto.ICMS.ICMS60.VBCSTRet        := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_ST_Ret.AsFloat) ,',','.');
  DetXML.Imposto.ICMS.ICMS60.PST             := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ST_Ret.AsFloat) ,',','.');
  DetXML.Imposto.ICMS.ICMS60.VICMSSubstituto := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_Icms_Substituto.AsFloat) ,',','.');
  DetXML.Imposto.ICMS.ICMS60.VICMSSTRet      := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ST_Ret.AsFloat) ,',','.');
  
  //4.00
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMS60.VBCFCPSTRet := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS60.PFCPSTRet   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS60.VFCPSTRet   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***************
  //26/02/2019
...
begin
  ...
  //4.00
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMS70.VBCFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS70.PFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS70.VFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat) ,',','.');
  end;
  //***************
  ...
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMS70.VBCFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS70.PFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS70.VFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***************
...
begin
  ...
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMS90.VBCFCP := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS90.PFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS90.VFCP   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_FCP.AsFloat) ,',','.');
  end;
  //***************
  ...
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMS90.VBCFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS90.PFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMS90.VFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***************
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVlrIcmsDesonerado.AsFloat)) > 0 then
  begin
...
begin
  ...
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMSSN201.VBCFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN201.PFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN201.VFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***************
...
begin
  ...
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMSSN202.VBCFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN202.PFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN202.VFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***************
end;                                                    
...
begin
  ...
  //4.00
  //if (vTipo_Consumidor = '1') and (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePercIcmsSubstInterno.AsFloat)) > 0) then
  //  DetXML.Imposto.ICMS.ICMSSN500.PST := Replace(FormatFloat('0.00',fDMNFe.mItensNFePercIcmsSubstInterno.AsFloat + fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat) ,',','.')
  //else
  //  DetXML.Imposto.ICMS.ICMSSN500.PST := Replace(FormatFloat('0.00',0) ,',','.');
  //****************
  //DetXML.Imposto.ICMS.ICMSSN500.VICMSSTRet := Replace(FormatFloat('0.00',fDMNFe.mItensNFeIcmsVlrSubst.AsFloat) ,',','.');

  //26/02/2019
  DetXML.Imposto.ICMS.ICMSSN500.VBCSTRet        := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_ST_Ret.AsFloat) ,',','.');
  DetXML.Imposto.ICMS.ICMSSN500.PST             := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ST_Ret.AsFloat) ,',','.');
  DetXML.Imposto.ICMS.ICMSSN500.VICMSSubstituto := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_Icms_Substituto.AsFloat) ,',','.');
  DetXML.Imposto.ICMS.ICMSSN500.VICMSSTRet := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ST_Ret.AsFloat) ,',','.');
  //***************

  //4.00
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMSSN500.VBCFCPSTRet := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN500.PFCPSTRet   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN500.VFCPSTRet   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***************
...
begin
  ...
  if (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat)) > 0) then
  begin
    DetXML.Imposto.ICMS.ICMSSN900.VBCFCPST := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN900.PFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFePERC_FCP_ST.AsFloat) ,',','.');
    DetXML.Imposto.ICMS.ICMSSN900.VFCPST   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_FCP_ST.AsFloat) ,',','.');
  end;
  //***************
...
begin
  ...
  begin
    ...
    //else
      //DupXML.NDup := IntToStr(NumNota) + '-' + FormatFloat('000',Parcela);
...
//Letra W - Totais - Grupo de Valores Totais referentes ao ICMS
  ...
  NfeXML.InfNFe.Total.ICMSTot.VFCPUFDest   := Replace(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_ICMS_FCP_DEST.AsFloat),',','.');
  ...
  //4.00
  NfeXML.InfNFe.Total.ICMSTot.VFCP := Replace(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_ICMS_FCP.AsFloat),',','.');
  //*********
  ...
  //4.00
  NfeXML.InfNFe.Total.ICMSTot.VFCPST    := Replace(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_FCP_ST.AsFloat),',','.');
  ...
  NfeXML.InfNFe.Total.ICMSTot.VDesc      := Replace(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_DESCONTO.AsFloat + fDMCadNotaFiscal.cdsNotaFiscalVLR_DESC_SUFRAMA.AsFloat - fDMCadNotaFiscal.cdsNotaFiscalVLR_ICMSDESONERADO.AsFloat),',','.');
  ...
  //4.00
  NfeXML.InfNFe.Total.ICMSTot.VIPIDevol  := Replace(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_IPI_DEVOL.AsFloat),',','.');
  //****************
...
{* X  Informações do transporte da NF-e }  //4.00 teve campos novos
  ...
  if fDMCadNotaFiscal.cdsNotaFiscalTIPO_FRETE.AsString = '4' then
    NfeXML.InfNFe.Transp.ModFrete := '3'
  else
  if fDMCadNotaFiscal.cdsNotaFiscalTIPO_FRETE.AsString = '5' then
    NfeXML.InfNFe.Transp.ModFrete := '4'
  else
  ...
  begin
    ...
    CobrXML.Fat.NFat  := FormatFloat('000',fDMCadNotaFiscal.cdsNotaFiscalNUMNOTA.AsInteger);
    CobrXML.Fat.VOrig := Replace(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_DUPLICATA.AsFloat),',','.');
    CobrXML.Fat.VDesc := Replace(FormatFloat('0.00',0),',','.');
    ...
    begin
      ...
      detPag.IndPag := '0';
      if fDMCadNotaFiscal.cdsTipoCobranca.Locate('ID',fDMCadNotaFiscal.cdsNotaFiscalID_TIPO_COBRANCA.AsInteger,([Locaseinsensitive])) then
        detPag.TPag := fDMCadNotaFiscal.cdsTipoCobrancaCOD_IMP_FISCAL.AsString
      else
        detPag.TPag := '';
      detPag.VPag := Replace(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_DUPLICATA.AsFloat),',','.');
    end
    else
    begin
      fDMNFe.cdsTPag.Close;
      fDMNFe.sdsTPag.ParamByName('ID').AsInteger := fDMCadNotaFiscal.cdsNotaFiscalID.AsInteger;
      fDMNFe.cdsTPag.Open;
      fDMNFe.cdsTPag.First;
      while not fDMNFe.cdsTPag.Eof do
      begin
        detPag := NfeXML.InfNFe.Pag.DetPag.Add;
        //detPag.IndPag := '1';
        detPag.TPag := fDMNFe.cdsTPagCOD_IMP_FISCAL.AsString;
        detPag.VPag := Replace(FormatFloat('0.00',fDMNFe.cdsTPagVLR_VENCIMENTO.AsFloat),',','.');
        fDMNFe.cdsTPag.Next;
      end;
    end;

    //else 28/06/2018
    if (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger <> 5) and (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger <> 6) then
    begin
      vVlrTotalNota := StrToFloat(FormatFloat('0.00',fDMCadNotaFiscal.cdsNotaFiscalVLR_NOTA.AsFloat - fDMCadNotaFiscal.cdsNotaFiscalVLR_DUPLICATA.AsFloat));
      if StrToFloat(FormatFloat('0.00',vVlrTotalNota)) > 0 then
      begin
        detPag := NfeXML.InfNFe.Pag.DetPag.Add;
        detPag.TPag := '90';
        if (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger = 1) or (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger = 3) then
          detPag.VPag := Replace(FormatFloat('0.00',vVlrTotalNota),',','.')
        else
          detPag.VPag := '0.00';
      end;
    end;
  ...
  begin
    if (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger <> 4) and (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger <> 6) then
    begin
      detPag := NfeXML.InfNFe.Pag.DetPag.Add;
      detPag.TPag   := '90';
      if (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger = 2) or (fDMCadNotaFiscal.qParametros_NFeENVIAR_VPAG_SEM_VLR.AsInteger = 3) then
        detPag.VPag := Replace(FormatFloat('0.00',vVlrTotalNota),',','.')
      else
        detPag.VPag := '0.00';
    end;
...
{* H  Detalhamento de Produtos e Serviços da NF-e }
  ...
  if (Trim(fDMNFe.mItensNFeCodBarra2.AsString) <> '') then
    DetXML.Prod.CEANTrib := Trim(fDMNFe.mItensNFeCodBarra2.AsString)
  else
  if (Trim(fDMNFe.mItensNFeCodBarra.AsString) <> '') then
...
{* O  Imposto sobre Produtos Industrializados }
  ...
  begin
    ...
    DetXML.Imposto.IPI.IPITrib.AddChild('vBC').Text  := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBase_IPI.AsFloat),',','.');
...
{* UA  Tributos Devolvidos (para o item da NF-e) }
  //Tag não implementada
  if StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVlrIPI_Devol.AsFloat)) > 0 then
  begin
    DetXML.ImpostoDevol.PDevol        := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_Devol.AsFloat),',','.');
    DetXML.ImpostoDevol.IPI.VIPIDevol := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVlrIPI_Devol.AsFloat),',','.');
  end;
...
procedure prc_Monta_ICMS_UF_Destino(fDMNFe : TDMNFe);
begin
  if ((StrToFloat(FormatFloat('0.000',fDMNFe.mItensNFePerc_ICMS_FCP.AsFloat)) > 0) and (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVLR_ICMS_FCP_DEST.AsFloat)) > 0))
  or ((StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFeVlr_ICMS_UF_Dest.AsFloat)) > 0) and (StrToFloat(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_UF_Dest.AsFloat)) > 0)) then
  begin
    DetXML.Imposto.ICMSUFDest.VBCUFDest      := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBaseICMS.AsFloat),',','.');
    DetXML.Imposto.ICMSUFDest.VBCFCPUFDest   := Replace(FormatFloat('0.00',fDMNFe.mItensNFeBASE_ICMS_FCP_DEST.AsFloat),',','.');
    ...
    DetXML.Imposto.ICMSUFDest.PICMSInterPart := Replace(FormatFloat('0.00',fDMNFe.mItensNFePerc_ICMS_Partilha.AsFloat),',','.');
    DetXML.Imposto.ICMSUFDest.VFCPUFDest     := Replace(FormatFloat('0.00',fDMNFe.mItensNFeVLR_ICMS_FCP_DEST.AsFloat),',','.');
