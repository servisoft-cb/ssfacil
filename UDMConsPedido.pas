...
type
  TDMConsPedido = class(TDataModule)
    ...
    sdsEtiqueta_Aux: TSQLDataSet;
    dspEtiqueta_Aux: TDataSetProvider;
    cdsEtiqueta_Aux: TClientDataSet;
    sdsParametros_EtiqUSA_ETIQUETA_AUX: TStringField;
    cdsParametros_EtiqUSA_ETIQUETA_AUX: TStringField;
    sdsEtiqueta_AuxID: TIntegerField;
    sdsEtiqueta_AuxID_PRODUTO: TIntegerField;
    sdsEtiqueta_AuxREFERENCIA: TStringField;
    sdsEtiqueta_AuxNOME_ETIQUETA: TStringField;
    sdsEtiqueta_AuxNOME_PRODUTO: TStringField;
    sdsEtiqueta_AuxPRECO_PRODUTO: TFloatField;
    sdsEtiqueta_AuxINFOCODBARRA: TStringField;
    sdsEtiqueta_AuxCODBARRA: TStringField;
    cdsEtiqueta_AuxID: TIntegerField;
    cdsEtiqueta_AuxID_PRODUTO: TIntegerField;
    cdsEtiqueta_AuxREFERENCIA: TStringField;
    cdsEtiqueta_AuxNOME_ETIQUETA: TStringField;
    cdsEtiqueta_AuxNOME_PRODUTO: TStringField;
    ...
    sdsPedido_Item_Proc: TSQLDataSet;
    dspPedido_Item_Proc: TDataSetProvider;
    cdsPedido_Item_Proc: TClientDataSet;
    cdsPedido_Item_ProcID: TIntegerField;
    cdsPedido_Item_ProcITEM: TIntegerField;
    cdsPedido_Item_ProcITEM_PROCESSO: TIntegerField;
    cdsPedido_Item_ProcID_PROCESSO: TIntegerField;
    cdsPedido_Item_ProcQTD: TFloatField;
    cdsPedido_Item_ProcDTENTRADA: TDateField;
    cdsPedido_Item_ProcHRENTRADA: TTimeField;
    cdsPedido_Item_ProcDTBAIXA: TDateField;
    cdsPedido_Item_ProcHRSAIDA: TTimeField;
    cdsPedido_Item_ProcQTD_DOBRA: TIntegerField;
    cdsPedido_Item_ProcNOME: TStringField;
    cdsPedido_Item_ProcORDEM_MAPA: TIntegerField;
    cdsPedido_Item_ProcNOME2: TStringField;
    dsPedido_Item_Proc: TDataSource;
    sdsPedido_RefComb_DtEPed: TSQLDataSet;
    dspPedido_RefComb_DtEPed: TDataSetProvider;
    cdsPedido_RefComb_DtEPed: TClientDataSet;
    dsPedido_RefComb_DtEPed: TDataSource;
    cdsPedido_RefComb_DtEPedQTD: TFloatField;
    cdsPedido_RefComb_DtEPedQTD_FATURADO: TFloatField;
    cdsPedido_RefComb_DtEPedQTD_RESTANTE: TFloatField;
    cdsPedido_RefComb_DtEPedQTD_CANCELADO: TFloatField;
    cdsPedido_RefComb_DtEPedQTD_PECA: TFMTBCDField;
    cdsPedido_RefComb_DtEPedVLR_TOTAL: TFloatField;
    cdsPedido_RefComb_DtEPedVLR_RESTANTE: TFloatField;
    cdsPedido_RefComb_DtEPedVLR_FATURADO: TFloatField;
    cdsPedido_RefComb_DtEPedVLR_CANCELADO: TFloatField;
    cdsPedido_RefComb_DtEPedREFERENCIA: TStringField;
    cdsPedido_RefComb_DtEPedNOME_COR_COMBINACAO: TStringField;
    cdsPedido_RefComb_DtEPedNOME_CLIENTE: TStringField;
    cdsPedido_RefComb_DtEPedDTENTREGA_ITEM: TDateField;
    cdsPedido_RefComb_DtEPedPEDIDO_CLIENTE: TStringField;
  ...
  public
    ...
    ctPedido_RefComb_DTEPed: String;
    ctPedido_Mat: String;
    ctPedido: String;
    ctPedido_Fat: String;
...
begin
  ...
  ctPedido_RefComb_DTEPed     := sdsPedido_RefComb_DtEPed.CommandText;
