...
begin
  ...
  //02/10/2019  Foi criada essa procedure  e colocado acima da leitura do CFOP 
  //prc_Monta_ICMS;
  //*****************
...
begin
  ...
  begin
    ...
    ffrmRecebeXML_ConsNota.vCodCliente  := vCodFornecedor;
...
begin
  ...
  begin
    if MessageDlg('Deseja gerar as referências internas na sequência?', mtConfirmation,[mbOk,mbNo],0)=mrYes then
      prc_Gerar_Ref;
  end;
end;
